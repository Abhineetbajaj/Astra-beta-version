// Seed copy for numbers 1-9 and master numbers 11/22/33, transcribed from a research pass across
// popular numerology sources (Yourpathnumbers, mindbodygreen, JobCannon, Centre of Excellence,
// GaneshaSpeaks, Hans Decoz, and named practitioners' own published descriptions). Treat as seed
// copy to be refined over time, not verbatim authoritative text — same caveat the research itself
// flagged. Shadow traits are deliberately framed as growth edges, never fixed flaws or fatalistic
// predictions, matching the tone the app's AI-generated readings are held to elsewhere.
